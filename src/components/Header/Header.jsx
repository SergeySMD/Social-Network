                ...
                <div className={s.dropdownContent}>
                    <NavLink to={`/profile/` + props.id}>
                        <div className={s.dropdownItem}>
                            ...
                            <div className={s.title}>My Page</div>
                    ...
                    <div className={s.dropdownItem} onClick={() => {
                        ...
                        <div className={s.title}>Sign Out</div>
                        <svg className={s.exitLogo} xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <g id="logout" transform="translate(0 -0.85)">
                                ...
                                <g id="Сгруппировать_87" data-name="Сгруппировать 87"
                                   transform="translate(7.973 5.834)">
    ...
    render() {
        return (
            <header className={s.header}>
                ...
                <div className={s.themeSlider}><Slider isDarkTheme={this.props.isDarkTheme} isThemeSlider={true}
                                                       callback={this.onToggleThemeClick}/></div>
            </header>
        )
    }
}
